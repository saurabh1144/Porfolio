...
const Intro = () => {
  ...
  return (
    ...
    <div className='introContent'>
        ...
        <span className='introName'> Saurabh </span><br/><span id='app'>Frontend Developer</span>
        ...
        <Link> <button className='btn'><img src={down} alt='icon' className='icon'/>Resume</button></Link>
        </span>
    </div>
    <img src={my} alt='img' className='myImg'/>
